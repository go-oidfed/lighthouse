...
| [`lhmigrate config2db`](../../migration/0.22.md) | Non-interactive migration from an existing (legacy) config file to the database.     |
...
| [`entity-configuration`](entity-configuration.md) | Entity configuration lifetime, entity metadata, authority hints, extra entity config claims                                                  |
| [`trust-marks`](trust-marks.md)                   | Published trust marks, trust mark specs & subjects, trust mark types, issuers, owners                                                         |
...
| [`subordinates`](subordinates.md)                 | General subordinate statement config (lifetime, constraints, metadata policies, additional claims) and per-subordinate JWKS refresh settings |
