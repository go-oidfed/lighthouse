...
func TestGetSubordinateMetadata(t *testing.T) {
	t.Parallel()
	t.Run(
		"Success/WithMetadata", func(t *testing.T) {
			t.Parallel()
			...
			if rp, ok := result[oidfedconst.EntityTypeOpenIDRelyingParty].(map[string]any); !ok || rp["client_name"] != "My App" {
...
func TestPutSubordinateMetadata(t *testing.T) {
	...
	t.Run(
		"Success", func(t *testing.T) {
			...
			req := httptest.NewRequest(
				"PUT", fmt.Sprintf("/subordinates/%d/metadata", saved.ID), strings.NewReader(body),
			)
	...
	t.Run(
		"InvalidBody", func(t *testing.T) {
			...
			req := httptest.NewRequest(
				"PUT", fmt.Sprintf("/subordinates/%d/metadata", saved.ID), strings.NewReader("bad json"),
			)
			req.Header.Set("Content-Type", "application/json")
			resp, bodyBytes := doRequest(t, app, req)
...
func TestGetSubordinateMetadataEntityType(t *testing.T) {
	...
	t.Run(
		"Success", func(t *testing.T) {
			...
			req := httptest.NewRequest(
				"GET", fmt.Sprintf("/subordinates/%d/metadata/custom_entity_type", saved.ID), http.NoBody,
			)
			resp, body := doRequest(t, app, req)
	...
	t.Run(
		"NotFound/EntityType", func(t *testing.T) {
			...
			req := httptest.NewRequest(
				"GET", fmt.Sprintf("/subordinates/%d/metadata/missing_type", saved.ID), http.NoBody,
			)
			resp, bodyBytes := doRequest(t, app, req)
...
func TestPutSubordinateMetadataEntityType(t *testing.T) {
	...
	t.Run(
		"Success", func(t *testing.T) {
			...
			req := httptest.NewRequest(
				"PUT", fmt.Sprintf("/subordinates/%d/metadata/target_type", saved.ID), strings.NewReader(body),
			)
			req.Header.Set("Content-Type", "application/json")
			resp, bodyBytes := doRequest(t, app, req)
	...
	t.Run(
		"InvalidBody", func(t *testing.T) {
			...
			req := httptest.NewRequest(
				"PUT", fmt.Sprintf("/subordinates/%d/metadata/target_type", saved.ID), strings.NewReader("bad json"),
			)
			req.Header.Set("Content-Type", "application/json")
			resp, bodyBytes := doRequest(t, app, req)
...
func TestPostSubordinateMetadataEntityType(t *testing.T) {
	...
	t.Run(
		"Success/Merge", func(t *testing.T) {
			...
			req := httptest.NewRequest(
				"POST", fmt.Sprintf("/subordinates/%d/metadata/target_type", saved.ID), strings.NewReader(body),
			)
			req.Header.Set("Content-Type", "application/json")
			resp, bodyBytes := doRequest(t, app, req)
	...
	t.Run(
		"InvalidBody", func(t *testing.T) {
			...
			req := httptest.NewRequest(
				"POST", fmt.Sprintf("/subordinates/%d/metadata/target_type", saved.ID), strings.NewReader("bad json"),
			)
			req.Header.Set("Content-Type", "application/json")
			resp, bodyBytes := doRequest(t, app, req)
...
func TestDeleteSubordinateMetadataEntityType(t *testing.T) {
	...
	t.Run(
		"Success", func(t *testing.T) {
			...
			req := httptest.NewRequest(
				"DELETE", fmt.Sprintf("/subordinates/%d/metadata/delete_me", saved.ID), http.NoBody,
			)
			resp, bodyBytes := doRequest(t, app, req)
	...
	t.Run(
		"NotFound/EntityType", func(t *testing.T) {
			...
			req := httptest.NewRequest(
				"DELETE", fmt.Sprintf("/subordinates/%d/metadata/missing_type", saved.ID), http.NoBody,
			)
			resp, bodyBytes := doRequest(t, app, req)
...
func TestGetSubordinateMetadataClaim(t *testing.T) {
	...
	t.Run(
		"Success", func(t *testing.T) {
			...
			req := httptest.NewRequest(
				"GET", fmt.Sprintf("/subordinates/%d/metadata/target_type/target_claim", saved.ID), http.NoBody,
			)
			resp, body := doRequest(t, app, req)
	...
	t.Run(
		"NotFound/Claim", func(t *testing.T) {
			...
			req := httptest.NewRequest(
				"GET", fmt.Sprintf("/subordinates/%d/metadata/target_type/missing", saved.ID), http.NoBody,
			)
			resp, bodyBytes := doRequest(t, app, req)
...
func TestPutSubordinateMetadataClaim(t *testing.T) {
	t.Parallel()
	t.Run(
		"Success/Replace", func(t *testing.T) {
			t.Parallel()
			app, backends := setupSubordinateMetadataApp(t)
			...
			req := httptest.NewRequest(
				"PUT", fmt.Sprintf("/subordinates/%d/metadata/target_type/target_claim", saved.ID),
...
func TestDeleteSubordinateMetadataClaim(t *testing.T) {
	...
	t.Run(
		"Success", func(t *testing.T) {
			...
			req := httptest.NewRequest(
				"DELETE", fmt.Sprintf("/subordinates/%d/metadata/target_type/delete_me", saved.ID), http.NoBody,
			)
			resp, bodyBytes := doRequest(t, app, req)
	...
	t.Run(
		"NotFound/Claim", func(t *testing.T) {
			...
			req := httptest.NewRequest(
				"DELETE", fmt.Sprintf("/subordinates/%d/metadata/target_type/not_here", saved.ID), http.NoBody,
			)
			resp, bodyBytes := doRequest(t, app, req)
